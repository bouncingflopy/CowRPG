...
illinod: int = 30
forevermore: int = 40
onetwo: List[int] = [9, 10, 11, 17, 18, 19, 21, 22, 23, 24, 33, 36, 66, 67, 68, 69, 70]
threefour: int = 80 ** 2
one2: int = 5
...
# UI
shmop = '../graphics/font/joystix.ttf'
shlong = 18
shling = 12
slhoop = 20
shlow = 200
...
ggggg = '#222222'
sdklsdfj = 100
qwertyuiop = ['green_cow', 'red_cow', 'pet_cow']
...
dddhyy = ['heal', 'strength', 'kettle', 'shield']
